...
public class SlidingItemLayout extends FrameLayout implements ISlidingLayout {
    ...
    private boolean close_other_layout;
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        switch (ev.getAction()) {
            case MotionEvent.ACTION_DOWN:
                ...
                if (getCurrentStaus() == SlidingStatus.Close && onSlideItemListener.getNoCloseCount() != 0) {
                    if (onSlideItemListener != null) {
                        onSlideItemListener.onCloseOther();
                        return false;
                    }
                }
                break;
            case MotionEvent.ACTION_MOVE:
                ...
                if ((onSlideItemListener.getNoCloseCount() == 0 && xOffset < 0) || getCurrentStaus() != SlidingStatus.Close) {
                    getParent().getParent().getParent().getParent().getParent().getParent().getParent()
                            .requestDisallowInterceptTouchEvent(true);
                } else {
                    getParent().getParent().getParent().getParent().getParent().getParent().getParent()
            ...
            case MotionEvent.ACTION_UP:
                if (close_other_layout) close_other_layout = false;
                getParent().getParent().getParent().getParent().getParent().getParent().getParent()
                        .requestDisallowInterceptTouchEvent(false);
                break;
        }
