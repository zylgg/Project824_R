...
public class AutoRotateSecondView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        String[] widthScales = circleRadiusScale.split("/");
        int scale0 = Integer.parseInt(widthScales[0]);
        int scale1 = Integer.parseInt(widthScales[1]);
        circleRadius = getWidth() * scale0 / scale1;
        //画外边框
